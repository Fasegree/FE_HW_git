...
// Переменная асинхронной функции
const fetchData = async () => {
  const userData = await getUsers();
  if (userData) {
    console.log(userData); // обработка данных, полученных после запроса
  } else {
...
function searchFilter(){
	let searchArr = [...arrData]
	searchArr = searchArr.filter(el => el.toLowerCase().includes(searchInput.value.toLowerCase()))
	searchList.innerHTML = '';
	searchArr.forEach((el, i) => {
