...
function multiplied(value) {
	...
	if (value != value || typeof (value) === 'string' || typeof (value) === 'boolean') {
		return 'Error'
	} else
...
console.log(multiplied(NaN))
console.log(multiplied(true))
